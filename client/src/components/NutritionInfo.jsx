...
export default function NutritionInfo ({plateIngredients, handleShowNutrition}) {
    ...
    const errorBody = <div className="font-extralight leading-snug text-2xl m-5 mt-6 text-center">
        We can't find the nutritional data of this plate.
    </div>
