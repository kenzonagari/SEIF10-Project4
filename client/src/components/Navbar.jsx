        ...
        <div className="px-4 sm:px-6 lg:px-8 bg-emerald-50 shadow-xl">
            <div className="flex h-16 items-center justify-around">
                <div className="flex justify-around items-baseline space-x-4">
                    ...
                    <Link to="/userPlates" className="text-gray-500 hover:bg-spray-700 hover:text-white px-3 py-2 rounded-md text-lg font-medium">{username ? username : "User"}'s Plates</Link>
